...
Depending on countries, the absolute value of the elasticity of the CPI to exchange rate shocks ranges from 5\% to 35\%, confirming the importance of global value chains in channeling external shocks to domestic inflation.
Most of the propagation of shocks passes throught imported final goods and domestic input-output linkages.
Using data from WIOD on a sample of 43 countries, the mean output-weighted elasticity of the CPI to exchange rate shocks increased in absolute value from 7.5\% in 2000 to 9.4\% in 2008.
It then declined to 8.8\% in 2014.
Extrapolations based on more up-to-date GDP and trade data suggest that this decline continued to 2016 and was reversed in 2017 and 2018. 
...
These findings are robust to using two recent versions of TIVA.
