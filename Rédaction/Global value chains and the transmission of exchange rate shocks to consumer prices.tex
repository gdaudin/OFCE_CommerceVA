...
Global value chains linkages play a more limited role. 
As WIOT are not available for the latest years, we estimate the HCE deflator elasticity from 2016 onwards using trade data and GDP statistics. 
We thus obtain a precise estimate of the elasticity without resorting to WIOT.
...
Indeed, the elasticity is estimated under the simplifying assumption of full exchange rate pass-through to import prices and under the producer pricing assumption.
Alternative pricing assumptions (such as, for instance, the pricing-to-market assumption) would entail lower elasticity values.  \\
