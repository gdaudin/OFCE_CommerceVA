...
In this paper, we document the role of global input-output linkages in the propagation of inflationary shocks in the international economy. 
...
We build on two sectoral datasets, the World Input Output Database (WIOD) and the OECD-ICIO database to assess the propagation of nominal shocks. We take advantage of the temporal dimension of the dataset to document the extent to which the growth in GVCs has changed inflation dynamics over time. We pay particular attention to the increasing integration of euro area economies since the adoption of the common currency and analyze to which extent the shortening of global value chains in the years following the Great Recession has changed the propagation of inflationary shocks in the international economy. We provide evidence that, following an appreciation of the domestic currency, the direct effect of global inflationary shocks, i.e. the share of imported final and intermediate goods in domestic consumption, explains the bulk of the propagation of global inflationary shocks to domestic prices. By contrast, we find a limited indirect effect, defined as the additional transmission of lower domestic input prices to other sectors of the domestic economy and to other countries which takes place during subsequent production cycles. We contribute to the literature on global input-output linkages by assessing whether results are consistent across the two world inptu output databases (WIOD and ICIO).
