...
Using alternative exchange rate pass-thorugh assumptions would thus entail lower elasticity values. 
We also assume that all pricing occur using the currency of the producing country (in line with the ‘producer currency pricing’ paradigm). 
...
Hence, pricing-to-market strategies of exporters aiming to defend their market shares would impply a lower exchange rate pass-through.
