...
As a result, our regressions only include a limited number of countries.
...
It is therefore possible to include many more countries in the new panel (see equation \ref{eq:eq10}).
...
We obtain similar results with other databases (revision 3 and revision 4 of TIVA)\footnote{Results are available upon request}.
