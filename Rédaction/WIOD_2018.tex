...
One might wonder whether using world input-ouput matrices provided by WIOD or TIVA is worth the wait (the latest version of WIOD only covers 2014) and the computational complexity. To answer this question, we break down $\overline{s_{i}}^{i,HC}$ into different elements classified by ease of use and computation. Let us start from equation \ref{eq:eqdomcurrency}.
