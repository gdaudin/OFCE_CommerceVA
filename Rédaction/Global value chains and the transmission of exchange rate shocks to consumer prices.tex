...
An important caveat is that our computations rely on several simplifying assumptions which biais our estimates upward. 
First, we assume exchange rate fluctuations completely pass-through to import prices. 
...
The magnitude of the upward biais stemming from our simplifying assumptions is unlikely to be constant in our sample given the cross-country heterogeneity.
The magnitude of the bias likely depends on the size of the economy. In particular, it is likely that in large and attractive markets, competitive pressures may push producers to adopt local currency pricing strategies, where exporting firms adapt their mark-ups depending on the destination market to offset exchange rate movements. 
