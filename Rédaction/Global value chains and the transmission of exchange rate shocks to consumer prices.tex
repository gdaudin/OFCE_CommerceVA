...
Still, household consumption and intermediate products are more difficult to collect systematically for most countries and years.\footnote{To illustrate this point, in Online Appendix G we use data from the World Bank and Eurostat, which are only available for 29 countries in our sample.}
...
This individual coefficents and their statistical significance are difficult to interpret because of multicolinearities among the explanatory variables.
