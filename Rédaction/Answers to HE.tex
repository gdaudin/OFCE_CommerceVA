...
We have the strange result that $E3 + E4$ seems to be constant, whatever the openness rate of the economy : 
...
The zone of interest is between 0.15 and 0.5. In that zone, the relationship between the oppeness rate and the residual is not monotonous, and actually does not vary much.
