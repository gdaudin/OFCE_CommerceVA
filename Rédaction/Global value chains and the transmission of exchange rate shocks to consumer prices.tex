...
Our results concur with \cite{Aydogus2018}, which examine pass-through to the domestic price level through an input–output model for 26 countries, using I-O tables. 
