...
\begin{figure}[H]
	\centering
	\caption{\footnotesize{\textbf{Evolution of the constant $\alpha$ (TIVA rev. 4)}}}
	\begin{tabular}{c}
...
When a shock $c$ occurs on the prices of country 2, we have the following initial shock vector : $C=\left(0,c\right)$.
...
Figure \ref{fig:pays_soucis_WIOD}) for WIOD confirms that such sharp increases have not been observed in the past and are hence unlikely (see Figure \ref{fig:pays_soucis_WIOD}).
