...
\footnote{Note that the upward biais stemming from our simplifying assumptions is unlikely to be constant. The magnitude of the biais likely depends on the size of the economy. In particular, it is likely that in large and attractive markets, competitive pressures may push producers to adopt local currency pricing strategies, where exporting firms adapt their mark-ups depending on the destination market to offset exchange rate movements. Hence, we would expect the upward biais in our estimated elasticities to be more pronounced for the largest and most attractive markets represented in our sample.} \\
