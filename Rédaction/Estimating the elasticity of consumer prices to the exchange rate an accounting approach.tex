...
As WIOTs are data-demanding and available with a lag of several years, we extrapolate a reliable year- and country-specific estimate of HCE deflator elasticity from 2015 onwards, using trade data and GDP statistics. 
...
\\
The first-step impact of the appreciation of the country $i$’s currency on the price of its inputs corresponds, in national currency, to $C^i{\tilde{{\cal B}^i}}$ where: 
\begin{eqnarray}
