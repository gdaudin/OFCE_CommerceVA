...
Another strand of macro-trade literature sheds light on the transmission of shocks across countries through input-output linkages.
Our paper uses and contributes to both strands of literature: while our computations are based on input/output matrices, our results are comparable with macro-trade estimations. 
