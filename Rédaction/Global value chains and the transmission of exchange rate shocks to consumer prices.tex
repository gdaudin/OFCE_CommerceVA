...
%VF Sprin 2021: je retire la reference a la monnaie ficitive comme convenu 
...
In the euro area, the elasticity to changes in the value of the euro ranges from 0.07 in Italy to 0.18 in Ireland, reflecting different degrees of openness to trade. This heterogeneity adds to the challenges faced by the European Central Bank in stabilizing prices throughout a monetary union. 
