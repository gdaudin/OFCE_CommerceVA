...
To address this gap, we use more up-to-date GDP and trade data. 
By doing so, we provide a tool to approximate the partial equilibrium impact of an exchange rate shock on consumer prices from 2016 onwards.
