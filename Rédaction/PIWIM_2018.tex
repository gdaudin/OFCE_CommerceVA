...
Most of the propagation of shocks passes through imported final goods and domestic input-output linkages.
...
We estimate successive cross-sections of equation \ref{eq:eq8} to check whether the proxy is satisfactory. 
 ...
 \begin{equation}
 \begin{array}{llll}
\overline{s}_{i}^{i,HC}= \alpha &+  \beta_1  \frac{\textnormal{imported consumption goods}_i}{\textnormal{household consumption}_i} \\ & +  \beta_2  \left[    \frac{\textnormal{imported intermediate goods}_i}{\textnormal{intermediate consumption}_i}*\left(1-\frac{\textnormal{imported consumption goods}_i}{\textnormal{household consumption}_i}\right)\right] +\varepsilon_i 
\end{array} 
\label{eq:eq8}
\end{equation}
...
& + \beta_4  \overline{\left[ \frac{\textnormal{imported intermediate goods}_{i,t}}{\textnormal{intermediate consumption}_{i,t}}*\left(1-\frac{\textnormal{imported consumption goods}_{i,t}}{\textnormal{household consumption}_{i,t}}\right) \right]} \\ 
...
& +  \beta_3  \overline{\frac{\textnormal{Total imported consumption goods}_{t}}{\textnormal{Total GDP}_{t}}} \\
& + \beta_4 \overline{ \frac{\textnormal{Total imported intermediate goods}_{t}}{\textnormal{Total GDP}_{t}}} \\
& +fe_{i}+\varepsilon_{i,t}
\end{array}
\label{eq:eq10}
\end{equation}
...
The CPI elasticity to a shock on the domestic currency ranges from 5\% and 35\%, depending mainly on the openness of countries.
