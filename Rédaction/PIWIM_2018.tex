...
\newpage
\section{Comparing $\overline{s}_{i}^{i,HC}$ and $E1.HC^{i,imp}+E2.HC^{i,dom}$ in the TIVA rev 3 and TIVA rev4 databases}
...
\newpage
\section{Studying the decomposition of the shock in the two country one sector case}
