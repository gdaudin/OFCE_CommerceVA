...
Such heterogeneity reflects mainly differences in foreign product content of consumption and intermediate consumption. 
...
By contrast, indirect effects linked to global value chains play a limited role. 
Our results are robust to using four different WIOT datasets. 
As WIOT are very data demanding, we extrapolate the HCE deflator elasticity computed from WIOD WIOT from 2015 onwards using trade data and GDP statistics. 
...
Understanding the influence of the exchange rate on inflation is critically important for setting monetary policy and measuring the extent of expenditure switching that follows exchange rate variations, which, in turn, has an impact on real activity.\\
%Data
...
That impact of exchange rate variations on consumer prices has remained broadly stable over the past two decades.
...
To fill the data gap, we extrapolate from our WIOD estimate (that stops in 2014) the impact of exchange rate variations on consumer prices using up-to-date GDP and trade statistics up to 2019.
This yields an estimate of the elasticity very close to the one computed from MRIO WIOT.
