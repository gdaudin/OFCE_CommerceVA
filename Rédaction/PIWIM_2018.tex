...
Depending on countries, the absolute value of the elasticity of the household consumption expenditure (HCE) deflator to the exchange rate ranges from 0.05 to 0.35, confirming the importance of global value chains in channeling external shocks to domestic inflation.
...
In the euro area, the elasticity of the HCE delfator to changes in the value of the euro ranges from 0.065 to 0.18. 
...
Using WIOD, we find that the absolute value of the elasticity of the HCE deflator to an exchange rate shock is 0.055 (or 0.055) for the US in 2011.
...
The Houshold consumption expenditure (HCE) deflator elasticity to a shock on the domestic currency ranges from 0.05 to 0.35, depending mainly on the openness of countries.
