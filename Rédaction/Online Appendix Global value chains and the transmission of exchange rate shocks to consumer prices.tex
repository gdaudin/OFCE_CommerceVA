...
\pagenumbering{gobble} % bce: PAS DE NUMERO DE PAGES
...
\newpage
\section*{Appendix C: Extrapolating the HCE deflator elasticity using household consumption, intermediate consumption and trade statistics}  % je n'avais pas propose un titre plus clair dans une precedent version?
