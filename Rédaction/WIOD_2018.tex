...
Figure \ref{fig:ratiodir} depicts the relationship between the elasticity of consumer prices to an exchange rate shock and the import intensity of consumption.

 \begin{figure}[!h]
\centering
\caption{\footnotesize{\textbf{Consumer prices elasticity to an exchange rate shock}}}
\begin{tabular}{c}
\includegraphics[width=5.0in, height=3.5in]{graph_2014_WIOD}\\
\floatfoot{Source: WIOD, 2014}.
\end{tabular}
\label{fig:ratiodir}
\end{figure}
