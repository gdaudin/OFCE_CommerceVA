...
Using data from WIOD on a sample of 43 countries, we find that the mean output-weighed elasticity of the HCE deflator to the exchange rate increased in absolute value from 7.5\% in 2000 to 9.4\% in 2008. 
