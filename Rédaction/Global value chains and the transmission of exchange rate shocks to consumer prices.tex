...
Results from the MRIO database suggest that the elasticity has bounced back from 2016 onwards, reaching 0.13 in 2018.
...
Our results are robust to using different databases  (see Figure \ref{fig:PIWIM_LONGITUDINAL}).
WIOD and MRIO provide similar results. 
This is unsurprising, given that the main difference between the databases relates to the broader geographic coverage of MRIO. 
MRIO includes nineteen additional emerging Asian economies. 
...
The small differences observed between WIOD and TiVA rev. 4 likely reflect different ways of reconciling national accounts and international trade statistics.
...
\begin{figure}[H]
	\centering
	\caption{\footnotesize{\textbf{Contribution of different products to the HCE deflator elasticity to the exchange rate}}}
	\begin{tabular}{c}
		\includegraphics[width=4.5in, height=3in]
		{decomp_sect.png}\\.
	\end{tabular}
