...
%recent studies using various methodologies (VAR, dynamic simultaneous equations, Bayesian VAR, local projections...) tend to obtain lower ERPT than ours, around 0.05 (see notably \cite{Hahn2003}, \cite{Comunale2017}, \cite{Colavecchio2020}).
...
%The Leontief's production model (or Input-Output model, I-O thereafter) analyses the impact of a demand shock in a closed economy \citep{Leontief1951}. Using the %trade in value-added analysis reconciles international trade statistics with national I-O tables, thus allowing to extend Leontief's analysis to an international %context.\\
...
\begin{thebibliography}{}
	...
	\bibitem[Amiti et~al., 2012]{Amiti2014}
	Amiti, M., Itskhoki, O., and Konings, J. (2012).
	\newblock {Importers, exporters, and exchange rate disconnect}.
	\newblock Working Paper Research 238, National Bank of Belgium.
	
	\bibitem[Aydoğuş et~al., 2018]{Aydogus2018}
	Aydoğuş, O., Çağaçan Değer, Çalışkan, E.~T., and Günal, G.~G. (2018).
	\newblock {An input–output model of exchange-rate pass-through}.
	\newblock {\em Economic Systems Research}, 30(3):323--336.
	
	\bibitem[Boz et~al., 2020]{Boz2020}
	Boz, E., Casas, C., Georgiadis, G., Gopinath, G., Le~Mezo, H., Mehl, A., and
	Nguyen, T. (2020).
	\newblock {Patterns in invoicing currency in global trade}.
	\newblock Working Paper Series 2456, European Central Bank.
	
	\bibitem[Boz et~al., 2019]{Boz2019}
	Boz, E., Gopinath, G., and Plagborg-Møller, M. (2019).
	\newblock {Dollar Invoicing and the Heterogeneity of Exchange Rate
		Pass-Through}.
	\newblock {\em AEA Papers and Proceedings}, 109:527--532.
	
	\bibitem[Cochard et~al., 2016]{Cochard2016}
	Cochard, M., Daudin, G., Fronteau, S., and Rifflart, C. (2016).
	\newblock Commerce vertical et propagation des chocs de prix: {{Le}} cas de la
	zone euro.
	\newblock {\em Revue de l'OFCE}, (149):131--166.
	
	\bibitem[Colavecchio and Rubene, 2020]{Colavecchio2020}
	Colavecchio, R. and Rubene, I. (2020).
	\newblock {Non-linear exchange rate pass-through to euro area inflation: a
		local projection approach}.
	\newblock Working Paper Series 2362, European Central Bank.
	
	\bibitem[De~Soyres et~al., 2018]{DeSoyres2018}
	De~Soyres, F., Frohm, E., Gunnella, V., and Pavlova, E. (2018).
	\newblock Bought, {{Sold}}, and {{Bought Again}}: {{The Impact}} of {{Complex
			Value Chains}} on {{Export Elasticities}}.
	\newblock Policy {{Research Working Paper}} 8535, {World Bank}.
	
	\bibitem[Dietzenbacher et~al., 2013]{Dietzenbacher2013}
	Dietzenbacher, E., Los, B., Stehrer, R., Timmer, M., and {de Vries}, G.~J.
	(2013).
	\newblock The {{Construction}} of {{World Input}}-{{Output Tables}} in the
	{{WIOD Project}}.
	\newblock {\em Economic Systems Research}, 25(1):71--98.
	
	\bibitem[Eaton et~al., 2016]{Eaton2016}
	Eaton, J., Kortum, S., Neiman, B., and Romalis, J. (2016).
	\newblock Trade and the global recession.
	\newblock {\em American Economic Review}, 106(11):3401--38.
	
	\bibitem[Feenstra and Jensen, 2012]{Feenstra2012}
	Feenstra, R.~C. and Jensen, J.~B. (2012).
	\newblock Evaluating {{Estimates}} of {{Materials Offshoring}} from
	{{U}}.{{S}}. {{Manufacturing}}.
	\newblock {{NBER Working Papers}} 17916, {National Bureau of Economic Research,
		Inc}.
	
	\bibitem[Folloni and Miglierina, 1994]{Folloni1994}
	Folloni, G. and Miglierina, C. (1994).
	\newblock Hypothesis of price formation in input-output tables.
	\newblock {\em Economic Systems Research}, 6(3):249--264.
	
	\bibitem[Forbes et~al., 2018]{Forbes2018}
	Forbes, K., Hjortsoe, I., and Nenova, T. (2018).
	\newblock {The Shocks Matter: Improving Our Estimates of Exchange Rate
		Pass-Through}.
	\newblock NBER Working Papers 24773, National Bureau of Economic Research, Inc.
	
	\bibitem[Gaulier and Zignago, 2010]{Gaulier2010}
	Gaulier, G. and Zignago, S. (2010).
	\newblock Baci: International trade database at the product-level (the
	1994-2007 version).
	
	\bibitem[Gopinath et~al., 2020]{Gopinath2020}
	Gopinath, G., Boz, E., Casas, C., D{\'i}ez, F.~J., Gourinchas, P.-O., and
	{Plagborg-M{\o}ller}, M. (2020).
	\newblock Dominant {{Currency Paradigm}}.
	\newblock {\em American Economic Review}, 110(3):677--719.
	
	\bibitem[Gopinath et~al., 2007]{Gopinath2010}
	Gopinath, G., Itskhoki, O., and Rigobon, R. (2007).
	\newblock Currency choice and exchange rate pass-through.
	\newblock NBER Working Papers 13432, National Bureau of Economic Research, Inc.
	
	\bibitem[Ha et~al., 2020]{Ha2020}
	Ha, J., Stocker, M.~M., and Yilmazkuday, H. (2020).
	\newblock {Inflation and Exchange Rate Pass-Through}.
	\newblock Working Papers 2004, Florida International University, Department of
	Economics.
	
	\bibitem[Johnson, 2014]{Johnson2014}
	Johnson, R.~C. (2014).
	\newblock Trade in intermediate inputs and business cycle comovement.
	\newblock {\em American Economic Journal: Macroeconomics}, 6(4):39--83.
	
	\bibitem[Leontief, 1951]{Leontief1951}
	Leontief, W.~W. (1951).
	\newblock {\em The Structure of {{American}} Economy, 1919-1939: An Empirical
		Application of Equilibrium Analysis.}
	\newblock {Oxford University Press}, {New York}, second edition.
	
	\bibitem[OECD, 2018]{OECD2018}
	OECD (Decembre 2018).
	\newblock What's new? {{Differences}} between the 2018 and 2016 edition of the
	{{TiVA}} indicators.
	\newblock http://www.oecd.org/industry/ind/tiva-2018-differences-tiva-2016.pdf.
	
	\bibitem[OECD and WTO, 2011]{OECD2011}
	OECD and WTO (2011).
	\newblock Trade in value-added: Concepts, methodologies and challenges (joint
	oecd-wto note).
	\newblock https://www.oecd.org/sti/ind/49894138.pdf.
	
	\bibitem[Ortega and Osbat, 2020]{Ortega2020}
	Ortega, E. and Osbat, C. (2020).
	\newblock Exchange rate pass-through in the euro area and in {{EU}} countries.
	\newblock Occasional {{Paper Series}} 241, {European Central Bank},
	{Frankfurt}.
	
	\bibitem[{\"O}zyurt, 2016]{Ozyurt2016}
	{\"O}zyurt, S. (2016).
	\newblock Has the exchange rate pass through recently declined in the euro
	area?
	\newblock {{ECB Working Paper}} 1955, {European Central Bank}, {Frankfurt}.
	
	\bibitem[Puzzello, 2012]{Puzzello2012}
	Puzzello, L. (2012).
	\newblock A proportionality assumption and measurement biases in the factor
	content of trade.
	\newblock {\em Journal of International Economics}, 87(1):105--111.
	
	\bibitem[Reddan and Rice, 2017]{Reddan2017}
	Reddan, P. and Rice, J. (2017).
	\newblock {Exchange Rate Pass-Through to Domestic Prices}.
	\newblock Economic Letters 08/EL/17, Central Bank of Ireland.
	
	\bibitem[Timmer et~al., 2015]{Timmer2015}
	Timmer, M., Dietzenbacher, E., Los, B., Stehrer, R., and {de Vries}, G.~J.
	(2015).
	\newblock An {{Illustrated User Guide}} to the {{World Input}}-{{Output
			Database}}: The {{Case}} of {{Global Automotive Production}}.
	\newblock {\em John Wiley and Sons Ltd}, page~31.
	
	\bibitem[Timmer et~al., 2016]{Timmer2016}
	Timmer, M.~P., Los, B., Stehrer, R., and de~Vries, G.~J. (2016).
	\newblock {An Anatomy of the Global Trade Slowdown based on the WIOD 2016
		Release}.
