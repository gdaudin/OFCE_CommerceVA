...
We analyse the impact of global inflationary shocks on the main components of consumer prices (manufacturing goods, services, food and energy). We also analyse the impact of global inflationary shocks on imported and domestic goods. 
...
Global value chain participation is a determinant of the exchange rate pass-through.
...
\cite{DeSoyres2018} find that a higher share of foreign value added in exports reduces the exchange rate pass-through (ERPT) to export prices and export volumes. In particular, the exchange rate pass-through declines most in France and Germany. \cite{Georgiadis2019} draw a causal link between the rise of global value chain (GVC) participation and the decline of exchange rate pass-through to import prices and estimate that the rise in global value chainparticiption account for 50\% of the decline in exchange rate pass-through to import prices since the mid-1990s. 
\cite{Hagemejer2020} find that growing GVC participation of the suppliers of imported intermediate input results in the reduction of the ERPT to producer prices. The exchange rate pass-through for countries whose suppliers are strongly involved in GVC is significantly smaller than for economies with suppliers not participating in GVC. 
...
The empirical literature proves that the pass-through declines across the pricing chain. \cite{Ortega2020} confirms that the pass-through is higher and faster for import prices at the border, but significantly smaller and relatively slower for final consumer prices (see also \cite{Hahn2003, Kunovac2017, BenCheikh2017}

In an input-output accounting perspective, the exchange rate pass-through to consumer prices is bounded by the direct and indirect import content of consumption. According to calculations based on the World Input-Output Database (WIOD),  \cite{Schaeffer2019} finds that the sum of the direct and indirect import content in consumption for the euro area was 16\% in the HICP and 14 per cent in the HICP excluding energy and food, HICPX, in 2014 under the assumption of full pass-through to import prices.
