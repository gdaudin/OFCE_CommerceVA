...
To address this gap, we estimate the HCE elasticity from 2015 onwards using trade data on consumption and intermediates and GDP statistics without resorting to WIOT.\\
% Plan
