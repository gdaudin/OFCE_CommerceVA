...
\begin{abstract}
{\small \noindent
New technologies and lower trade barriers have given rise to increased interaction among sectors across countries. The growth of global value chains (GVCs) reflects the international integration of geographically fragmented global production processes and the creation of global production networks.
In this paper, we build on two sectoral datasets, the World Input Output Database (WIOD) and the OECD-ICIO database to assess the role of global input-output linkages in the propagation of inflationary shocks in the international economy. 
...
We take advantage of the temporal dimension of the dataset to document whether the growth in GVCs has changed inflation dynamics over time. We pay particular attention to the increasing integration of euro area economies since the adoption of the common currency and analyze whether the shortening of global value chains in the years following the Great Recession has changed the propagation of inflationary shocks. We provide evidence that, following an appreciation of the domestic currency, the direct effect of global inflationary shocks, i.e. the share of imported final and intermediate goods in domestic consumption, explains the bulk of the propagation of global shocks to domestic prices. By contrast, we find a limited role for the additional transmission of lower domestic input prices to other sectors of the domestic economy and other countries occuring during subsequent production cycles. We contribute to the literature on global input-output linkages by assessing whether results are consistent across the different world input output databases available, namely WIOD and OECD-ICIO.
}
...
Firms' participation in global value chains strengthens cross-country linkages via trade in intermediate inputs. In this paper, we use World Input-Output tables (WIOT hereafter) to investigate how production linkages give rise to nominal spillovers. We pay particular attention to euro area countries. These countries have been increasingly participating in cross-border production chains following the adoption of the common currency. The euro area is indeed more involved in global production chains than other large economies, such as the United States and China \citep{ECB2016} and has been less affected by global value chains shortening than other countries in the years following the Great Recession. \\
The remainder of the paper is organized as follows. Section \ref{sec:lit} briefly describes the related literature. Section \ref{sec:metho} presents the methodology and the data sources.  Section \ref{sec:prixconso} presents the impact of an exchange rate shock to consumer prices. 
...
\label{sec:lit}
This paper is related to two strands of literature: (\textit{i}) the role of trade in intermediate inputs in inflation comovement accross countries and (\textit{ii}) 

\paragraph{Input-output linkages and inflation comovement accross countries}
...
\cite{Goldberg2010} show that imported intermediate inputs are the dominant channel through wich changes in import prices pass to CPI inflation.
...
\paragraph{}
\paragraph{Our contribution to the literature}
We improve on the literature on various respects. First, while most of the literature focusses on production prices, we examine the role of inptut-output linkages in propagating shocks to consumer prices. Secondly, we analyze to what extent sectoral inflation reacts to global inflationnary shocks by examining the main components of consumer prices (manufacturing goods, services, food, energy). Thirdly, we assess whether results are robust to the use of different databases (WIOD versus OECD-ICIO). Finally, we provide evidence that, following an appreciation of the domestic currency, the direct effect of global inflationary shocks, i.e. the share of imported final and intermediate goods in domestic consumption, explains the bulk of the propagation of global shocks to domestic prices. By contrast, we find a limited role for the additional transmission of lower domestic input prices to other sectors of the domestic economy and other countries occuring during subsequent production cycles.
...
\paragraph{Major differences between the two databases}
...
\begin{figure}[!h]
\centering
\caption{\footnotesize{\textbf{Ratio of imported intermediate inputs and consumer goods to consumption (WIOD, 2014)}}}
\begin{tabular}{c}
...
Figure \ref{fig:ratioimp} depicts the imported  ratio, defined as the ratio of imported final and intermediate goods to household domestic consumption for the last year available (2014).
...
In the euro area, Figure \ref{fig:ratioimptemp_ze} shows that the imported ratio increased in most member states over the last decade. Following the adoption of the euro, the imported ratio increased between 2000 and 2007 in all countries, except in the southern economies (Spain, Portugal, Greece). The imported ratio keep expanding in the major economies of the area (Germany, France), but receeded in countries striken by the sovereign-debt crisis (Spain, Italy, Portugal and Greece).
Outside of the euro area, Figure \ref{fig:ratioimptemp} shows that the imported ratio has expanded over the last fifteen years, with the exception of China and Russia, where it declined somewhat following the 2008-2009 crisis. 
\begin{figure}[!h]
\centering
\caption{\footnotesize{\textbf{Evolution of the ratio of imported intermediate inputs and consumer goods to consumption in the euro area (WIOD)}}}
\begin{tabular}{c}
...
\begin{figure}[!h]
\centering
\caption{\footnotesize{\textbf{Evolution of the ratio of imported intermediate inputs and consumer goods to consumption (WIOD)}}}
\begin{tabular}{c}
