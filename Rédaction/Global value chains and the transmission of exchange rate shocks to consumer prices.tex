...
The U.S. is Ireland's major trading partner outside of the EU, even if a large portion of US imports (pharmaceuticals products and aircraft) are later exported by Irish-based firms without being purchased by Irish consumers \citep{Reddan2017}, and therefore have a negligible contribution to domestic consumer goods inflation.
...
Section \ref{sec:Extrapolations} provides more arguments on that point.\\
...
TIVA rev. 3 suggests that the output-weighed elasticity has increased by 25\% between 1995 and 2008, reaching 0.1 in 2008. \\
...
\label{sec:extrapo}
\subsection{Channels from exchange rate variations to HCE deflator}
