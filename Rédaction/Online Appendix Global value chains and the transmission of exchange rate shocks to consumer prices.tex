...
Figure \ref{fig:pays_soucis_WIOD}) for WIOD confirms that such sharp increases were not observed in the past and are thus unlikely (see Figure \ref{fig:pays_soucis_WIOD}).
...
\begin{figure}[H]
	\centering
	\caption{\footnotesize{\textbf{Comparing country-specific HCE deflator elasticities computed from MRIO data in 2016, 2017 and 2018.}}}
	\begin{tabular}{c}
...
\begin{figure}[H]
	\centering
	\caption{\footnotesize{\textbf{Comparing country-specific HCE deflator elasticities computed from WIOD data in 2012, 2013 and 2014.}}}
	\begin{tabular}{c}
