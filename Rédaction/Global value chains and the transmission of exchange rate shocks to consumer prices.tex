...
\textit{iv)} changes in domestic and foreign production costs in turn pass through to the price of inputs for domestic and foreign goods, causing further production costs variations through input-output linkages.\\
...
% We hope this will help explain and improve the variety of inflation elasticities to the exchange rate used in forecasting models.\\

\newpage 
\section*{Introduction}
%Nouvelle intro avril 2021 ou non technical summary
This paper examines the elasticity of the household consumption expenditure (HCE hereafter) deflator to the exchange rate. 
%Data
