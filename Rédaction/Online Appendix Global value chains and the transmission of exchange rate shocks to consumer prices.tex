...
\begin{document}
\title{Global value chains and the transmission of exchange rate shocks to consumer prices \\ Online Appendix	\thanks{ All programs are available at \url{https://github.com/gdaudin/OFCE_CommerceVA}. Data and results files are available upon request.}\\
\vspace{1cm}
}
\vspace{1cm}
\date{\today}
...
Section 4.1 shows that the sum of the share of imported goods in household consumption and the share of imported inputs in household consumption of domestic goods (E1.HC + E2.HC) is a good predictor of the effect of exchange rate fluctuations on household consumption prices. 
...
Section 4.2 shows that trade and GDP data are a good predictor too.
In this appendix we do an intermediary exercise by relying on a proxy by identifying consumption and intermediary goods imports using UN Comtrade data and the BEC classification.
...
In the same way, Figure \ref{fig:evolution_b_reg2} mimicks Figure 12 in the main text. 
...
\newpage
\section*{Online appendix D: Comparison of $S$ and $S^i$ in the two-country, one-sector case}
...
\newpage
\section*{Online Appendix E: Study of the decomposition of the shock in the two-country, one-sector case}\label{AnalyticalAppendix}
...
\newpage
\section*{Online Appendix F: MRIO data issues}

Figure \ref{fig:panel_pred3} (also in the main text) shows that extrapolating from WIOD, World Bank and BACI data the CPI elasticity for the period 2015-2019 gives results that are very close to those obtained with MRIO in 2016-2017, but not in 2018 or 2019.
We believe this result is due to a glitch in MRIO data we acceded on March 2021.
As shown by Figure \ref{fig:pays_soucis_MRIO}, the HCE deflator elasticity estimated thanks to the MRIO data increased by more than 20\% for India and China between 2017 and 2018.
For China, that increase was nearly 100\%.
This is not plausible.
Nothing like this happens between 2016 and 2017. 
Nothing like this happens in the last years of WIOD data (see Figure \ref{fig:pays_soucis_WIOD}).
Looking more closely in the data, it appears that according to MRIO, Chinese households’ consumption of Chinese education services has increased by 43\% between 2017 and 2018 and that Chinese households’ consumption of Chinese transport services has decreased by 43\% in the same period.
Again, this does not seem plausible.
...
\begin{figure}[H]
	\centering
	\caption{\footnotesize{\textbf{Comparing the country-specific HCE deflator elasticity computed from MRIO data in 2016, 2017 and 2018.}}}
	\begin{tabular}{c}
...
\begin{figure}[H]
	\centering
	\caption{\footnotesize{\textbf{Comparing the country-specific HCE deflator elasticity computed from WIOD data in 2012, 2013 and 2014.}}}
	\begin{tabular}{c}
