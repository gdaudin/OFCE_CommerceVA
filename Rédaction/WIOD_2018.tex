...
As shown by Figure \ref{fig:comp_WIOD_TIVA}, despite their differences, using WIOD or TIVA yields very comparable results. 
\begin{figure}[!h]
\centering
\caption{\footnotesize{\textbf{Comparing WIOD and TIVA, 2011}}}
\begin{tabular}{c}
\includegraphics[width=5.0in, height=3.5in]{Comparaison_WIOD_TIVA_2011.png}\\
