...
Household consumption and intermediate products are more difficult to collect systematically for many countries and many years. In Online Appendix F, we use data from the World Bank and Eurostat, which are only available for a limited number of countries. Hence, the study reported in Online Appendix F only includes a limited number of observations.
