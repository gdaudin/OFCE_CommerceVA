...
Still, household consumption and intermediate products are more difficult to collect systematically for many countries and many years. In Online Appendix F, we use data from the World Bank and Eurostat, which are only available for only 29 countries in our sample.
