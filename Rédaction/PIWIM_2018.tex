...
The empirical literature proves the pass through declines across the pricing chain. An ECB report \cite{Ortega2019} confirms the pass through is highest and fastest for import prices at the border, but significantly smaller and relatively slower for final consumer prices (see also \cite{Hahn2003, Kunovac2017,BenCheikh2017}
...
Concerning the evolution of the pass through over time, \cite{Campa and Goldberg2019}, \cite{Campa2008} have documented a fall in ERPT to import and consumer prices since the 1980s and 90s . Concerning possible differences across countries, \cite{Bussiere2016} find no significant difference in the import pass-through between emerging and advanced economies.
