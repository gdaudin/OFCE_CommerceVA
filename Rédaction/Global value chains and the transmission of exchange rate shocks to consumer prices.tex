...
The elasticity is stable over time but heterogeneous across countries, reflecting different degrees of openness to trade and differences in foreign product content in domestic consumption. 
...
This paper uses several multi-year WIOTs: the World Input Output Database (WIOD), the MRIO database developed by the Asian Development Bank and the Trade in Value Added Database (TiVA) from the OECD-ICIO.
...
In the WIOD database, disaggregate information is available for a limited number of Asian economies. 
To address the analytical needs related to the Asian and the Pacific Region, the Asian
...
The industrial aggregations and the conceptual framework of the ADB MRIO (and hence the methods used in the construction of the
tables) are the same as that of the WIOD.
