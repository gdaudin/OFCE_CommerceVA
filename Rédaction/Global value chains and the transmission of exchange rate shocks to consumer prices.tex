...
\label{sec:extrapo}
\subsection{Estimating the HCE deflator elasticity using the share of imported goods and imported inputs in household consumption}
...
Our predictions from 2015 onwards are in line with results from MRIO.


\begin{figure}[H]
	\centering
	\caption{\footnotesize{\textbf{Comparing the output-weighed HCE deflator elasticity to predictions based on World Bank and Comtrade data.}}}
	\begin{tabular}{c}
