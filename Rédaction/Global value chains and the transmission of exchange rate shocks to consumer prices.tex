...
Our predictions are in line with results from MRIO up to 2016. For the most recent years, there seem to be data issues in MRIO (see Online Appendix F), which the comparison helps to identify. 
