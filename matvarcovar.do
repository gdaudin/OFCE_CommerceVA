...
if ("`c(username)'"=="n818881") do  "X:\Agents\LALLIARD\commerce_VA_inflation\Definition_pays_secteur.do" `source'
 ...
 use "$dir/Results/Étude rapport D+I et Bouclage Mondial/Elast_par_pays_2000_WIOD_HC.dta"
...
corrtex E1HC E2HC E3HC E4HC, key(table:corretable1) file("corrtable_1.tex") replace digits(2) title("Cross-correlation of $\overline{s}_{i}^{i,HC}$'s components (1)")

gen E1HC_and_E2HC=E1HC + E2HC
gen E3HC_and_E4HC=E3HC + E4HC

corrtex E1HC E2HC E3HC E4HC, key(table:corretable2) file("corrtable_2.tex") replace digits(2) title("Cross-correlation of $\overline{s}_{i}^{i,HC}$'s components (2)")
