...
\cite{DeSoyres2018} find that a higher share of foreign value added in exports reduces the exchange rate pass-through to export prices and export volumes. In particular, the exchange rate pass-through declines most in France and Germany. \cite{Georgiadis2019} draw a causal link between the rise of global value chain participation and the decline of exchange rate pass-through to import prices over the last decades and estimate that the rise in global value chainparticiption account for 50\% of the decline in exchange rate pass-through to import prices since the mid-1990s. \cite{Hagemejer2020} find that the exchange rate pass-through is four times smaller for suppliers highly integrated in global value chains than for economies not participating in global value chains. 
