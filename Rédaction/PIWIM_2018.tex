...
It compare conclusions from three sectoral world input-output datasets (two versions of TiVA and WIOD) using Cobb-Douglas production functions in a partial equilibrium setting.
