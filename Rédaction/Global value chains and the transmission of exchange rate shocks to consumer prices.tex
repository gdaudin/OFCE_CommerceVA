...
%The Leontief's production model (or Input-Output model, I-O thereafter) analyzes the impact of a demand shock in a closed economy \citep{Leontief1951}. Using the %trade in value-added analysis reconciles international trade statistics with national I-O tables, thus allowing to extend Leontief's analysis to an international %context.\\
