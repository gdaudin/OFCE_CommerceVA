...
Hence,
\begin{eqnarray*}
 c_{\$}=\left(0\ldots0\ldots{{c}}_{\${ij}}}\ldots{{{c}}_{\${ik}}} 0\ldots0\right)$ with $c_{\${ij}}=c_{\$ik}}=c_{\$i}}=1
 \end{eqnarray*}
for all sectors $j$ and $k$ in the shocked country $i$.\\
Building on equation Equation \ref{eq:eq1}, we write the direct impact of the exchange rate shock on the other countries as the product of the shock vector $c_{\$}$ and a matrix $B$. $B$ builds on the large matrix $A$ of technical coefficients, but only keeps the coefficients of each country's sectoral inputs imported from the shocked country $i$. The other coefficients are replaced by 0, including those of the block of country $i$ concerning the domestic inputs of the shocked country $i$. The direct impact of the appreciation of a currency against the dollar on the price of inputs is equal to $c_{\$}B$
 with
 \begin{eqnarray}
c_{\$}B=\left(0\ldots{{{c}}_{\$i}}\ldots 0\right)\left(\begin{matrix}0&\cdots&0\\{{{a}}_{1l}}}{{\text{a}}_{{ij}}}&0&{{{a}}_{{nl}}}{{{a}}_{{ij}}}\\0&\cdots&0\\\end{matrix}\right) 	
 \label{eq:eq3}
 \end{eqnarray}
...
From Equation \ref{eq:eq2}, we can write the direct impact for country $i$ of the fall in input prices from the rest of the world. The direct impact corresponds to the product of the shock vector ${\tilde{c}}$  and a matrix ${\tilde{B}}$. $\widetilde{{B }$ builds on the large matrix A of which only the country blocks of the inputs imported by country $i$ from other countries have been retained. The other coefficients are replaced by 0, including those of the block of country $i$ concerning the domestic inputs of the shocked country $i$. \\
...
\begin{eqnarray*}
	{{S}_{\$}}=\Delta{{P}_{\$}}={{c}_{\$}}+({{c}_{\$}}{B}+{{{\tilde{c}}}_{\$}}{\tilde{B}}\right)+\left({{c}_{\$}}{B}+{{{\tilde{c}}}_{\$}}{\tilde{B}}\right){A}+\left({{c}_{\$}}{B}+{{{\tilde{c}}}_{\$}}{\tilde{B}}\right){{{A}}^{2}}+\ldots+\left({{c}_{\$}}{B}+{{{\tilde{c}}}_{\$}}{\tilde{B}}\right){{{A}}^{{n}}} \\
 \end{eqnarray*}
 \begin{eqnarray}
...
Equation \ref{eq:eq5} gives the absolute evolution of input prices in international currency. To obtain the absolute evolution of the input prices of the shocked country in national currency, we remove the exchange rate shock and multiply this balance by the scalar of conversion equal to $\frac{1}{1+{{{c}}_{\$i}}}=0.5~$, since according to our hypotheses ${{{c}}_{\$i}}$=1:
	$\text{S}=\left( \frac{1}{1+{{c}_{\$i}}}\right)*\left({{S}_{\$}}-{{c}_{\$}}\right)$\\
...
\overline{s_{i}^{X}}=\underset{j=1}{\overset{n}{\mathop \sum }}\,\frac{{{s}_{ij}}.{{x}_{ij}}}{{{x}_{i}}},
 \end{eqnarray*} 
with ${{{x}}_{{ij}}}$the exports of industry $j$ in country $i$ and ${{{x}}_{{i}}}$ the total exports of country $i$. \\
...
\overline{s_{i}^{HC}}=\underset{j=1}{\overset{n}{\mathop \sum }}\,\frac{{{s}_{ij}}.h{{c}_{ij}}}{h{{c}_{i}}}
 \end{eqnarray*} 
with ${h}{{{c}}_{{ij}}}$ the consumption of industry $j$ in country $i$ and ${h}{{{c}}_{{i}}}$ the total household consumption of country $i$. 
