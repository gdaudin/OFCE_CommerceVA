...
Using WIOD, we also estimate the impact of an appreciation of the US dollar (USD) on its trading partners, with a focus on the euro area.
...
The elasticity of the HCE deflator to the USD is close to 0.12 for Canada and 0.09 for Mexico.
...
Our results are robust to using different databases. 
