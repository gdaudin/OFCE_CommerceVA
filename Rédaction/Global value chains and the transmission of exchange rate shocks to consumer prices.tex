...
\paragraph{The Input-Output model applied to a shock on production costs} 
\label{subsec:io}
...
Inputs substitution (for instance, between countries producing the same goods) is not accounted for, despite variations in relative prices.
