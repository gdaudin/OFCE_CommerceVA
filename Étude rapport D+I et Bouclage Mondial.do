...
save "$dir/Results/Devaluations/Pour_HC_Graph_1_`source'_old3.dta", replace
export delimited "$dir/Results/Devaluations/Pour_HC_Graph_1_`source'_old3.csv", replace
