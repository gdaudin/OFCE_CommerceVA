...
Last but not least, we use several WIOTs databases and show that our findings are robust to different datasets (i.e. WIOD, two distinct releases
of the OECD TiVA database and the MRIO database). \\
