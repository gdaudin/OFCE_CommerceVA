...
Hence, we do not consider the fact that the pass-through might be incomplete, as suggested by a large body of literature (see for example \cite{Ortega2020} for a literature review of recent studies relying on various methodologies such as VAR, dynamic simultaneous equations, Bayesian VAR or local projections). 
