...
For the shocked country, the shock has a disinflationary effect on domestic production prices. In national currency, the production prices of imported inputs fall by $\widetilde{c}_i}=-\frac{c_{\$i}}{1+{c_{\$i}}}$, or by 0.5 with $c_{\$i}=1$. \\
...
\begin{eqnarray*}
 {{\Delta }^{1}}p_{ij}=\underset{l=1}{\overset{l=n}{\mathop \sum }}\,{\tilde{c}_{i}}*a_{ij}a_{1l}}+\ldots +\underset{l=1}{\overset{{l}=n}{\mathop \sum }}\,{{\tilde{c}}_i}*a_{ij}a_{kl}+\underset{l=1}{\overset{l={n}}{\mathop \sum }}\,{{{\tilde{c}}}_{i}}*{{a}_{{ij}}}{{{a}}_{\text{pl}}}=\left( -\frac{{{c}_{\$i}}}{1+c_{\$i}}}\right)*\underset{\begin{matrix}k=1\\k\nei\\\end{matrix}}{\overset{{k}=\text{p}}{\mathop\sum}}\,\left[\underset{l=1}{\overset{l=n}{\mathop\sum}}\,{a_{ij}a_{kl}\right] \\
\end{eqnarray*}
