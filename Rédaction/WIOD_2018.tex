...
To investigate whether the import intensity of consumption is a good predictor of domestic consumer prices reactions to changes in import price, we run the following cross-section regression (Equation \ref{eq:eq7}). 
