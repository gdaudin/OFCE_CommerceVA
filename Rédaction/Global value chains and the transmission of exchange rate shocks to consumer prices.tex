...
This heterogeneity reflects different degrees of openness to trade. 
For instance, for a large and relatively closed economy like the US, we find an elasticity of 0.06 in 2011. 
...
In this paragraph, we document the evolution of the elasticity of the HCE deflator to the exchange rate over time.
We find that the elasticity has remained broadly stable over the past two decades.
...
Using data from TIVA rev. 3 yields a higher elasticity  (see Figure \ref{fig:PIWIM_LONGITUDINAL}). 
